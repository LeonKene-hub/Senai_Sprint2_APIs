        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTipoUsuairo = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Usuario", x => x.IdUsuario);
                    table.ForeignKey(
                        name: "FK_Usuario_TiposUsuario_IdTipoUsuairo",
                        column: x => x.IdTipoUsuairo,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdUsuairo = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdEvento = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComentariosEvento_Usuario_IdUsuairo",
                        column: x => x.IdUsuairo,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PresencasEvento_Usuario_IdUsuairo",
                        column: x => x.IdUsuairo,
                        principalTable: "Usuario",
                        principalColumn: "IdUsuario",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComentariosEvento_IdUsuairo",
                table: "ComentariosEvento",
                column: "IdUsuairo");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PresencasEvento_IdUsuairo",
                table: "PresencasEvento",
                column: "IdUsuairo");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Usuario_IdTipoUsuairo",
                table: "Usuario",
                column: "IdTipoUsuairo");
        }
